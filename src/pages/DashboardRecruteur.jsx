...
export default function DashboardRecruteur() {
  ...
  const st = {
    ...
    tab: (active) => ({ padding: "10px 24px", borderRadius: "8px", border: active ? "none" : "1px solid #333", background: active ? "#f97316" : "transparent", color: active ? "#000" : "#aaa", fontWeight: active ? 600 : 400, cursor: "pointer", fontSize: "14px" }),
  ...
  return (
    <div style={st.page}>
      ...
      <OnboardingGuide key={onboardingKey} userId={recruteurId} steps={RECRUTEUR_ONBOARDING_STEPS} accentColor="#f97316" />
      <FloatingHelper userId={recruteurId} onReplayOnboarding={replayOnboarding} faq={RECRUTEUR_FAQ} accentColor="#f97316" />
      <nav style={st.navbar}>
          ...
          <div style={{ maxWidth: "680px", margin: "0 auto" }}>
            ...
            <div style={{ background: "#111", border: "1px solid #1a1a1a", borderRadius: "16px", padding: "24px", marginTop: "16px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                ...
                <button onClick={() => window.open(stripeUrl(STRIPE_LINKS_RECRUTEUR.annuel, recruteurId, recruteur?.email), '_blank')} style={{ background: "#f97316", color: "#000", border: "none", padding: "12px 20px", borderRadius: "10px", fontSize: "14px", fontWeight: 700, cursor: "pointer" }}>Annuel — 100€/an</button>
              </div>
            </div>
          </div>
        )}
