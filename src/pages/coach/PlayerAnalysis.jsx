    ...
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(360px, 1fr))', gap: '14px' }}>
        {demandesFiltrees.map(demande => {
          ...
          return (
            <div key={demande.id} style={{ background: c.surface, border: `1px solid ${demande.statut === 'en_attente' ? rgba(c.warn, 0.3) : c.border}`, borderRadius: '10px', padding: '1.25rem', display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '10px', marginBottom: '4px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
                  ...
                  <p style={{ margin: 0, fontWeight: 700, fontSize: '14px', color: c.text, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{profil?.prenom} {profil?.nom}</p>
                </div>
                <span style={{ background: rgba(getStatutColor(c, demande.statut), 0.15), color: getStatutColor(c, demande.statut), fontSize: '11px', padding: '3px 10px', borderRadius: '20px', fontWeight: '600', whiteSpace: 'nowrap', flexShrink: 0 }}>
              ...
              {videoUrl ? (
                ...
                <div style={{ background: c.surface2, borderRadius: '8px', padding: '0.75rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ marginTop: 'auto' }}>
                  ...
                  <div style={{ background: c.surface2, borderRadius: '10px', padding: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', flexWrap: 'wrap' }}>
                      <input
                        ...
                        style={{ flex: 1, minWidth: '160px', background: c.surface, border: `1px solid ${c.border}`, borderRadius: '8px', padding: '10px 14px', color: c.text, fontSize: '14px', outline: 'none' }}
                      />
                      <button
                ...
                {demande.statut === 'analyse' && demande.loom_url && (
                  <div style={{ background: rgba(c.success, 0.08), border: `1px solid ${rgba(c.success, 0.3)}`, borderRadius: '8px', padding: '1rem' }}>
                    <p style={{ fontSize: '12px', color: c.success, fontWeight: 600, margin: '0 0 6px' }}>Analyse envoyée — notification joueur envoyée</p>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                      <a href={demande.loom_url} target="_blank" rel="noreferrer"
                        ...
                        <IcoPlay size={13} /> <span style={{ textDecoration: 'underline' }}>Ouvrir la vidéo d'analyse</span>
                      </a>
