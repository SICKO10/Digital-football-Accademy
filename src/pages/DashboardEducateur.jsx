...
Si une info n'est pas visible, mets un tableau vide [] ou null selon le champ.`
  ...
  return (
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: 'Inter, sans-serif', display: 'flex', overflowX: 'hidden' }}>
      ...
      <div style={{ flex: 1, minWidth: 0, maxWidth: activeSection === 'accueil' ? '1400px' : '1100px', margin: '0 auto', padding: isMobile ? '16px 14px' : '1.25rem 1.5rem', paddingTop: isMobile ? 'calc(16px + env(safe-area-inset-top, 0px))' : '1.25rem' }}>
