-- Ajoute deux rôles staff événementiels/logistiques (Responsable Buvette,
-- Responsable Sécurité) à la liste des rôles autorisés sur staff_club et
-- role_permissions. Complète (ne remplace pas) les rôles existants pour ne
-- pas casser les clubs déjà en production.
do $$
declare
  c record;
begin
...
alter table staff_club
  ...
  check (role in (
    ...
    'responsable_buvette', 'responsable_securite'
  ));
